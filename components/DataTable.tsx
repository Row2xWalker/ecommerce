...
const DataTable = ({ data, columns }) => {
    ...
    return (
        <div><table className="w-full">
                ...
                {table.getRowModel().rows.map(row => (
                    <tr key={row.id} className="border border-black">
                        {row.getVisibleCells().map(cell => (
                            <td className="bg-white text-center w-[200px] border border-black" key={cell.id}>
            ...
            <div className="border border-black flex gap-2 justify-center text-black font-bold">
